...
namespace RN_Process.DataAcces.SqlServer
{
    public abstract class SqlEntityFrameworkCrudRepositoryBase<TEntity, V, TDbContext> :
        SqlEntityFrameworkRepositoryBase<TEntity, V, TDbContext>, IRepository<TEntity, V>
